...
var zIndexToName = Object.keys(_constants.layers).reduce(function (acc, name) {
  var layerName = name;

  var value = _constants.layers[layerName]();
...
var Portal = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(Portal, [{
    ...
    value: function componentDidMount() {
      ...
      firePortalEvent(_constants2.PORTAL_MOUNT_EVENT, Number(zIndex));
    }
  }, {
    ...
    value: function componentWillUnmount() {
      ...
      firePortalEvent(_constants2.PORTAL_UNMOUNT_EVENT, Number(zIndex));
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return container && portalIsMounted ? /*#__PURE__*/_reactDom.default.createPortal(this.props.children, container) : null;
    }
  }]);
  return Portal;
